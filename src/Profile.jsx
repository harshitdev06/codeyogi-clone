           ...
           <dl>
             <div className="p-5 border-b grid grid-cols-3 gap-4 items-center">
               ...
               <dd className="col-span-2">
                 <div className="m-1"> <input type="text" className="appearance-none
              ...
              <div className="p-5 border-b grid grid-cols-3 gap-4 items-center">
               ...
               <dd className="col-span-2">
                 <div className="m-1"> <input type="number" className="appearance-none
                  relative block w-full px-3
                  py-2 border border-gray-300
                  placeholder-gray-500 text-gray-900
                  bg-gray-50
              ...
              <div className="p-5 border-b grid grid-cols-3 gap-4 items-center">
               ...
               <dd className="col-span-2">
                 <div className="m-1"> <select type="text" className="appearance-none
                  relative block w-full px-3
                  py-2 border border-gray-300
                  placeholder-gray-500 text-gray-900
                  bg-gray-50
             ...
             <div className=" p-5 ">
               <button className="px-10 text-sm font-medium inline-block py-2 bg-indigo-700 text-white rounded-md"> Update</button>
