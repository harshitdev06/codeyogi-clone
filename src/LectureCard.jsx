    ...
    return(
        <li className="w-full border-2 border-gray-100 bg-white rounded-lg shadow-lg mb-5 ">
            <div className="p-3">
                ...
                <div className="inline-block mt-3  p-1 text-medium font-medium">
            ...
            <div className=" px-8 border-t  ">
                ...
                <a href={props.lectureLink} type="blank" className="flex justify-center items-center space-x-2 text-center">
